...
val test23 = number_in_months_challenge([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,4]) = 3
val test24 = number_in_months_challenge([(2012,2,28),(2013,12,1),(2011,3,31),(2011,3,31),(2011,4,28)],[2,3]) = 3
val test25 = number_in_months_challenge([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[]) = 0
val test26 = number_in_months_challenge([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[1]) = 0

val test27 = dates_in_months([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,4]) = [(2012,2,28),(2011,3,31),(2011,4,28)]
val test28 = dates_in_months([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3,4,12]) = [(2012,2,28),(2011,3,31),(2011,4,28),(2013,12,1)]
val test29 = dates_in_months([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[2,3]) = [(2012,2,28),(2011,3,31)]
val test30 = dates_in_months([(2012,2,28),(2013,12,1),(2011,3,31),(2011,4,28)],[1,2,3,4]) = [(2012,2,28),(2011,3,31),(2011,4,28)]
val test31 = dates_in_months([],[2,3,4]) = []
val test32 = dates_in_months([(2012,2,28),(2013,12,1),(2011,3,31)],[]) = []
